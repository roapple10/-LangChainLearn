# 這個程式使用GoogleGenerativeAIEmbeddings 
# https://developers.googleblog.com/en/gemini-embedding-available-gemini-api/
# https://python.langchain.com/api_reference/google_genai/embeddings/langchain_google_genai.embeddings.GoogleGenerativeAIEmbeddings.html?utm_source=chatgpt.com
